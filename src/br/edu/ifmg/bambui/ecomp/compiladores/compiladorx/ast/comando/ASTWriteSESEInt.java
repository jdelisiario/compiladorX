...
public class ASTWriteSESEInt extends ASTComando {
    ...
    public ASTWriteSESEInt(String mensagem, ASTExpressao expressao, String mensagem2, ASTExpressao expressao2) {
